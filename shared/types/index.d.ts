...
export interface CrawlManifestResponse {
  provider: string; domain: string; aiacta_version: '1.0';
...
export interface CitationEvent {
  aiacta_version: '1.0'; provider: string; event_type: 'citation.generated';
...
export interface CitationBatch { batch_id: string; aiacta_version: '1.0'; events: CitationEvent[]; }
